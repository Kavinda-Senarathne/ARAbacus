...
public class SaveManager : MonoBehaviour
{
    ...
    public object GameManager { get; set; }
    ...
    private void Save()
    {
        ...
        Block[,,] b = Game_Manager.Instance.blocks;
    ...
    private void Load()
    {
        ...
        Game_Manager.Instance.ResetGrid();
        for (int i = 1; i < blockData.Length-1 ; i++)
        {
            ...
            Game_Manager.Instance.CreateBlock(x,y,z,b);
        }
     ...
     for(int i = 0; i < saveCounter; i++)
        {
            ...
            string s = saveData[0];
            go.GetComponent<Button>().onClick.AddListener(() => OnSaveClick(saveData[0]));
